...
/* Whitix specific defines here */
#define HAVE_MMAP 1
#define HAVE_MREMAP	0
#define HAVE_MORECORE 0
#define MORECORE	SysMoreCore
...
#include <stddef.h>
#include <stdlib.h>
/* End of Whitix specific defines */
...
#define MFAIL                ((void*)(0))
#define CMFAIL               ((char*)(0))/* defined for convenience */
...
#ifndef WIN32
#define CALL_MUNMAP(a, s)    SysMemoryUnmap((a), (s))
...
#define MMAP_FLAGS           (_SYS_MMAP_PRIVATE)
#define CALL_MMAP(s)         SysMemoryMap(0, (s), 7, -1, 0, MMAP_FLAGS)
